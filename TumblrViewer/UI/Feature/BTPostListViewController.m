...
@interface BTPostListViewController () <UICollectionViewDataSource,CHTCollectionViewDelegateWaterfallLayout,BTPostContentActionDelegate, UIScrollViewDelegate>
...
@implementation BTPostListViewController
